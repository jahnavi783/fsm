...
class FSMListPageTemplate<T> extends StatelessWidget {
  ...
  // 🔥 ADDED FIELD
  final VoidCallback onVoiceSearchTap; // <-- added
  ...
  const FSMListPageTemplate({
    ...
    this.padding,
    this.backgroundColor,
    required this.onVoiceSearchTap, // <-- FIXED: now a required constructor param
  });
      ...
      children: [
        ...
        if (showSearch || showFilters)
          FSMSearchFilterHeader<T>(
            ...
            onVoiceSearchTap: onVoiceSearchTap, // <-- FIXED passthrough
          ),
