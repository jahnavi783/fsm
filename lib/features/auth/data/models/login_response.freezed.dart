...
mixin _$LoginResponse {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, message, accessToken, refreshToken, user);

  @override
  String toString() {
    return 'LoginResponse(message: $message, accessToken: $accessToken, refreshToken: $refreshToken, user: $user)';
  }
}
...
extension LoginResponsePatterns on LoginResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String message, String accessToken, String refreshToken,
            UserDto user)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LoginResponse() when $default != null:
        return $default(
            _that.message, _that.accessToken, _that.refreshToken, _that.user);
      case _:
        return orElse();
    }
  }
