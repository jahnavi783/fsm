...
abstract class $DocumentHiveModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(13) List<String> categories,
      @HiveField(14) DateTime cachedAt,
...
/// @nodoc
@JsonSerializable()
class _$DocumentHiveModelImpl extends _DocumentHiveModel {
  const _$DocumentHiveModelImpl(
      {@HiveField(0) required this.id,
      @HiveField(1) required this.title,
      @HiveField(2) required this.description,
      @HiveField(3) required this.fileUrl,
      @HiveField(4) required this.fileType,
      @HiveField(5) required this.fileSize,
      @HiveField(6) required this.category,
      @HiveField(7) this.relatedModel,
      @HiveField(8) this.keywords,
      @HiveField(9) this.uploadedBy,
      @HiveField(10) required this.createdAt,
      @HiveField(11) required this.updatedAt,
      @HiveField(12) final List<String> tags = const [],
      @HiveField(13) final List<String> categories = const [],
      @HiveField(14) required this.cachedAt,
      @HiveField(15) this.isDownloaded,
      @HiveField(16) this.localPath})
      : _tags = tags,
        _categories = categories,
        super._();
  ...
  @override
  String toString() {
    return 'DocumentHiveModel(id: $id, title: $title, description: $description, fileUrl: $fileUrl, fileType: $fileType, fileSize: $fileSize, category: $category, relatedModel: $relatedModel, keywords: $keywords, uploadedBy: $uploadedBy, createdAt: $createdAt, updatedAt: $updatedAt, tags: $tags, categories: $categories, cachedAt: $cachedAt, isDownloaded: $isDownloaded, localPath: $localPath)';
  }
...
abstract class _DocumentHiveModel extends DocumentHiveModel {
  const factory _DocumentHiveModel(
      {@HiveField(0) required final int id,
      @HiveField(1) required final String title,
      @HiveField(2) required final String description,
      @HiveField(3) required final String fileUrl,
      ...
      @HiveField(7) final String? relatedModel,
      @HiveField(8) final String? keywords,
      @HiveField(9) final int? uploadedBy,
      ...
      @HiveField(13) final List<String> categories,
      @HiveField(14) required final DateTime cachedAt,
      @HiveField(15) final bool? isDownloaded,
      @HiveField(16) final String? localPath}) = _$DocumentHiveModelImpl;
  const _DocumentHiveModel._() : super._();
