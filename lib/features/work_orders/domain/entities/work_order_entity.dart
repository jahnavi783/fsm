...
abstract class WorkOrderEntity with _$WorkOrderEntity {
  ...
  // ✅ FIXED: Use the serviceRequestNumber field directly if available
  // Otherwise generate from srId as fallback
  String get displayServiceRequestNumber =>
      serviceRequestNumber ?? 'SR-${srId.toString().padLeft(12, '0')}';
}
