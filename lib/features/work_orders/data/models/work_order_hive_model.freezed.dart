...
abstract class $PartHiveModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(6) int stockQuantity,
      @HiveField(7) String unit,
      @HiveField(8) List<String> compatibleModels,
...
class _$PartHiveModelImpl implements _PartHiveModel {
  const _$PartHiveModelImpl(
      ...
      @HiveField(6) required this.stockQuantity,
      @HiveField(7) required this.unit,
      @HiveField(8) final List<String> compatibleModels = const [],
      @HiveField(9) this.imageUrl,
      @HiveField(10) this.specifications})
  ...
  @override
  String toString() {
    return 'PartHiveModel(id: $id, partNumber: $partNumber, name: $name, description: $description, category: $category, price: $price, stockQuantity: $stockQuantity, unit: $unit, compatibleModels: $compatibleModels, imageUrl: $imageUrl, specifications: $specifications)';
  }
...
abstract class _PartHiveModel implements PartHiveModel {
  const factory _PartHiveModel(
      ...
      @HiveField(6) required final int stockQuantity,
      @HiveField(7) required final String unit,
      @HiveField(8) final List<String> compatibleModels,
      @HiveField(9) final String? imageUrl,
      @HiveField(10) final String? specifications}) = _$PartHiveModelImpl;
