...
class WorkOrderStartBottomSheet extends StatefulWidget {
  final WorkOrderEntity workOrder;
  final LocationEntity? currentLocation;

  const WorkOrderStartBottomSheet({
    super.key,
  ...
  @override
  State<WorkOrderStartBottomSheet> createState() =>
      _WorkOrderStartBottomSheetState();
}

class _WorkOrderStartBottomSheetState extends State<WorkOrderStartBottomSheet> {
