...
class AppTextStyles {
  ...
  // Additional Figma-specific text styles
  static TextStyle get primaryText => bodyMedium.copyWith(
        color: AppColors.textPrimary,
      );

  static TextStyle get secondaryText => bodySmall.copyWith(
        color: AppColors.textSecondary,
      );

  static TextStyle get tertiaryText => bodySmall.copyWith(
        color: AppColors.textTertiary,
      );

  static TextStyle get quaternaryText => bodySmall.copyWith(
