...
//                       field.didChange(List<File>.from(control.value ?? []));
//                     },
//                   );
//                 },
//               ),
...
/// Reusable reactive image picker widget
/// Integrates with reactive forms for image management
class ReactiveImagePicker extends StatelessWidget {
  final String formControlName;
  final int maxImages;
  final bool required;
  ...
  Future<void> _pickImage(
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        // Get current files
        final currentFiles = List<File>.from(field.value ?? []);

        // Add new file
        currentFiles.add(file);

        // Update form control
        field.control.updateValue(currentFiles);
        field.control.markAsTouched();
        field.control.markAsDirty();
        field.didChange(currentFiles);
      } else {}
    } catch (e, stackTrace) {}
  }
