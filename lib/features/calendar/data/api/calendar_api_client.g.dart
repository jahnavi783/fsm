...
class _CalendarApiClient implements CalendarApiClient {
  ...
  Future<List<CalendarEventDto>> getCalendarEvents({
    ...
    final _options = _setStreamType<List<CalendarEventDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data!
          .map((dynamic i) =>
              CalendarEventDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<CalendarEventDto>> getWeeklySchedule(
      {required String weekStart}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<CalendarEventDto> createEvent(
      {required CalendarEventDto event}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = event;
    final _options = _setStreamType<CalendarEventDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
